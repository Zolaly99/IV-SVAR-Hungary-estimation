...
df_2002_0 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2002_1")
df_2002 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2002_2")
df_2003 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2003")
df_2004 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2004")
df_2005 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2005")
df_2006 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2006")
df_2007 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2007")
df_2008 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2008")
df_2009 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2009")
df_2010 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2010")
df_2011 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2011")
df_2012 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2012")
df_2013 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2013")
df_2014 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2014")
df_2015 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2015")
df_2016 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2016")
df_2017 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2017")
df_2018 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2018")
df_2019 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2019")
df_2020 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2020")
df_2021 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2021")
df_2022 <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "Refhozam_2022")
...
#Referenciahozamok összefűzése, adattranszformációk
df <- rbind(df_2002_0, df_2002, df_2003, df_2004, df_2005, df_2006, df_2007, df_2008, df_2009, df_2010,
  ...
  mutate("Day_of_the_week"= (wday(.$Dátum)-1),
         "FOMC"           = (as.character(.$Dátum) %in% FOMC_days %>% as.integer() %>% lag(., n=1) %>% replace(.,is.na(.),0)), #FOMC kreálása: azon napok kijelölése, amikor volt monpol döntés. A lag amiatt kell, mert a VAR-ban levő adott napi kötvényhozamok változásai (Változás), amelyekből képezzük az instrumentumot, 13.45 és 14.00 közötti értékeket képviselnek, amelyek az adott napi kamatdöntések előtti értékek. Így a "Változás" változó azon értékeit kell venni majd, amelyek a kamatdöntési naphoz kötődnek. Ezt úgy oldom meg ehelyett, hogy az FOMC-napot csúsztatom el 1-gyel.
  ...
  group_by(Futamidő, YearMonth) %>%
  
  mutate("Hozam" = mean(`Hozam (%)`), 
         "Instrument" = sum(Változás[FOMC=="1"])) %>%   #Instrumentum kiszámolása: adott hónap és futamidő szerint a "Változás" változó azon értékeinek összege, amelyek kamatdöntő napok hatását tükrözik
  ...
  pivot_wider(names_from = Futamidő, values_from = c("Hozam", "Instrument")) %>%
...
df_neer <- read_excel("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "NEER") %>% 
...
#Beolvasás, 2000 előtti adatok kitörlése
ind_prod <- read.xlsx("C:/Users/MSI laptop/Desktop/IV-SVAR/IV-SVAR_data.xlsx", sheet = "IP", detectDates = TRUE) %>% 
...
fra <- read_excel("C:/Users/MSI laptop/Downloads/FRA.xlsx") %>% 
...
#DATASET_FACTORS[1:6, 3:6] <- 0

write.csv(DATASET_VAR, "C:/Users/MSI laptop/Desktop/IV-SVAR/DATASET_VAR_TDK.csv", row.names=FALSE)
write.csv(DATASET_FACTORS, "C:/Users/MSI laptop/Desktop/IV-SVAR/DATASET_FACTORS_TDK.csv", row.names=FALSE)
